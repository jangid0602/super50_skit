            ...
            switch(choice)
            {
                ...
                case 3:
                    try
                    {
                        ...
                        System.out.println(" minimum number of flips required to make all elements equal :"+myarray3.flipTheSwitch());
                        break;
                    }
                    catch (InputMismatchException e) 
                    {
                ...
                case 6:
                    try
                    {
                        ...
                        System.out.println(" the minimum total time after skipping one wall is :"+myarray6.minimalistPainter());
                        break;
                    }
                    catch (InputMismatchException e) 
                    {
