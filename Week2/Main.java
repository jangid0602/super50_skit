...
/**
 * @Filename-Main.java
 * @Description-This is the entry point for menu driven program
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("\n========= MAIN MENU =========");
            System.out.println("1. Encoded String Subset");
            System.out.println("2. Trendsetter Score");
            System.out.println("3. Max Pairs");
            System.out.println("4. Longest Balanced");
            System.out.println("5. Redact Message");
            System.out.println("6. Replace Substring");
            System.out.println("7. Most Frequent two step path");
