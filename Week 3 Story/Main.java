        ...
        for (int i = 0; i < n; i++) {
            while (true) {
                try {
                    ...
                    arr[i] = sc.nextLine();
                    if (arr[i].trim().isEmpty()) throw new Exception("Cannot be empty!");
                    break;
                } catch (Exception e) {
                    ...
                    case 3: // 2D Linked List Transpose
                        ...
                        for (int i = 0; i < r; i++) {
                            ...
                            for (String p : parts) {
                                ...
                                if (rowHead == null) rowHead = node;
                                if (prev != null) prev.right = node;
                                prev = node;
                            }
                            if (prevRow == null) head2D = rowHead;
                            else {
                   ...
                   case 6: // Leaky Bucket
                    ...
                    case 8: // Collapsing Count List
                        ...
                        for (int i = 0; i < n8; i++) {
                            ...
                            if (headCount == null) headCount = node;
                            else tailCount.next = node;
                            tailCount = node;
                        }
