...
public class Methods {
   ...
   public static boolean isValidIndentation(String[] lines) {
        ...
        try {
            ...
            while (d != null) {
                ...
                while (c != null) {
                    ...
                    if (colPrev != null) colPrev.right = newNode;
                    colPrev = newNode;
                    c = c.right;
                    colIdx++;
                }
    ...
    public static class LeakyBucket {
        private Deque<Object> dq; // deque(Object) because we can store any data type in object as it is a superclass of all datatypes
    ...
    try {
        ...
        while (!dq.isEmpty()) {
            ...
            for (int i = 0; i < sz; i++) {
                ...
                if (node.child != null) nextLevel.add(node.child);
            ...
            if (!leftToRight) Collections.reverse(nextLevel);
            for (ZigNode n : nextLevel) dq.addFirst(n);
