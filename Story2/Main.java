/**
 * @filename Main.java
 * The Main class serves as the **driver program** to demonstrate and test the 
 * array and string manipulation methods implemented across the MyArray, 
 * Arrayoperations, and Stringoperations classes.
 *
 * @author Priyanshu Joshi
 * @class Main
 * @description Provides a **menu-driven interface** for interactively executing 
 * and validating solutions to various programming challenges, including 
 * array-based algorithms (like Trendsetter Score) and advanced string processing 
 * (like SKU Normalization and Chat Message Redaction). It handles user input 
 * and displays results for all problems in the assignment's scope.
 */
package Java.openup.story2;
...
import Java.openupvs.Assignment5.MyArray;
import Java.openupvs.Assignment5.Stringoperations;
...
public class Main {
    public static void main(String[] args) {
        ...
        int ch = 0; // variable for taking user choice (initialization in case of catch block
                    // execution)
                    ...
                    while (!resize) {
                        try {
                            ...
                            if (windowsize > arraysize) {
                                ...
                                System.out.println(" Window size must be a positive integer. Please try again.");
                            }
