...
public class HashmapAndStringProblems {
    ...
    int getTrendScore(int posts[], int k) {
        if (k > posts.length)
            return 0;
    ...
    public int getMaxNumberOfPairs(int[] nums, int k) {
        Map<Integer, Integer> freq = new HashMap<>();
        int pairs = 0;
    ...
    public int getLongestColorBalancedSubarray(int[] nums) {
    ...
    public int getResumeSimilarityScore(String[] resumeV1, String[] resumeV2) {
